...
export default function Screen1({ content1="", content2="", content3="" }) {
            ...
            <div className="
                ...
                text-center responsive-container">
                    ...
                    <section className="mb-4 w-1/2 lg::w-1/3">
                        <p className="">
                        Etherwise helps you unify your brand identity by collecting, storing and<br />distributing design tokens and assets — automatically.
                        </p>
                    </section>
